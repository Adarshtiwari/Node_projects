...
const {CreateEvent } = require("../Service/event_service");
...
//     console.log(" the main handler", typeof req);
//     return {
...
// module.exports.handler = serverless(app).use(CreateEvent());
